...
public class Population : MonoBehaviour
{
  ...
  public void InitializePopulation(int popSize)
  {
    ...
    //   population = saveManager.LoadPopulation(path).population;

    //   if (population == null)
    //   {
    //     // Handle the case where no population data was loaded
    //     Debug.Log("No existing population found. A new population will be initialized.");
    //   }
    //   else
    //   {
    //     Debug.Log("Population loaded successfully.");
    //     return;
    //   }
    // }
